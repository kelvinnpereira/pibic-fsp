...
public class Scanner {
	...
	static {
		...
		literals.put("FIMTRACE", new Integer(6));
		literals.put("const", new Integer(19));
		literals.put("range", new Integer(21));
		literals.put("forall", new Integer(32));
		literals.put("STOP", new Integer(36));
		literals.put("ERROR", new Integer(37));
		literals.put("when", new Integer(38));
		literals.put("if", new Integer(39));
		literals.put("then", new Integer(40));
